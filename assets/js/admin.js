        ...
        $.post(tbSearch.ajax_url, {
            ...
            if (response.success) {
                ...
                if (!data.done) {
                    ...
                    resultsDiv.html('<div style="color:#166534; background:#dcfce7; padding:12px; border-radius:4px;"><strong>Success!</strong> Processed ' + totalProcessed + ' posts and structured ' + totalUpdated + ' with bus details.<br>You can now use the [trainbasher_bus_search] shortcode on any page.</div>');
                }
            } else {
